      ...
      <div class="flex flex-wrap pt-16 lg:py-32">
        ...
        <ul class="w-full lg:w-1/2 px-4">
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://marketplace.visualstudio.com/items?itemName=be5invis.vscode-custom-css"
        ...
        <ul class="w-full lg:w-1/2 px-4">
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://marketplace.visualstudio.com/items?itemName=mblode.twig-language-2"
        ...
        <ul class="w-full lg:w-1/2 px-4">
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://laravel.com/docs/5.8/valet"
        ...
        <ul class="w-full lg:w-1/2 px-4">
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://chrome.google.com/webstore/detail/adblock/gighmmpiobklfepjocnamgkkbiglidom"
          ...
          <li class="mb-4 italic text-sm">
            ...
            >Facebook Pixel Helper</a> — to see my trackers while I'm being tracked.
          </li>
        </ul>
        <ul class="w-full lg:w-1/2 px-4">
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://chrome.google.com/webstore/detail/tag-assistant-by-google/kejbdjndbnbjgmefkgdddjlbokphdefk?hl=en"
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://chrome.google.com/webstore/detail/streamkeys/ekpipjofdicppbepocohdlgenahaneen?hl=en"
        ...
        <ul class="px-4 w-full lg:w-1/2">
          ...
          <li class="mb-4 italic text-sm">
            ...
            >CleanMyMac X</a> — when I'm feeling dirty.
          </li>
        </ul>
        <ul class="px-4 w-full lg:w-1/2">
          <li class="mb-4 italic text-sm">
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://www.adobe.com/au/products/illustrator.html"
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://www.adobe.com/au/products/xd.html"
          ...
          <li class="mb-4 italic text-sm">
            ...
            <a
              target="_blank"
              rel="noopener"
              href="https://www.adobe.com/au/products/indesign.html"
